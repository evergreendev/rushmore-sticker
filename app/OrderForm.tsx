        ...
        <form action={checkout} className="flex flex-wrap items-center gap-8 mb-8">
            <div>
                ...
                <input
                    ...
                    id="name"
                    name="name"
                    className="border-slate-500 border-[1px] text-xl px-2 py-4 rounded"
                    onChange={(e) =>
            ...
            <div>
                <label htmlFor="age-division" className="font-bold mr-2">Age Division:</label>
                <select name="age-division" required id="age-division" className="border-slate-500 border-[1px] text-xl">
                    <option>
                        10U
                    </option>
                    <option>
